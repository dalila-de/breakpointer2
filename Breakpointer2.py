...
parser.add_argument('input_paf', '--input_paf', help='This is the alignment file', required=True)
parser.add_argument('input_ins_score_sp1', '--input_ins_score_sp1', help= 'FAN-C insulation score for sp1', required=True)
parser.add_argument('input_ins_score_sp2', '--input_ins_score_sp2', help= 'FAN-C insulation score for sp2', required=True)
parser.add_argument('sp1', '--sp1', help = 'species 1 in .paf file', required=True)
parser.add_argument('sp2', '--sp2', help = 'species 2 in .paf file', required=True)
parser.add_argument('len_co', '--len_co', help='minimum alignment length to be kept', default=100000, type=int)
parser.add_argument('len_bp', '--len_bp', help = 'distance needed to call a break', default=5000000, type=int)
parser.add_argument('q', '--q', help = 'quality cutoff value', default=30, type=int)
parser.add_argument('num_rounds', '--num_rounds', help='number of permutations for one-tailed permutation test', default=100000, type=int)
parser.add_argument('output_fin_tab', '--output_fin_tab', help='Overall table', required=True)
